...
class PembinaController extends Controller
{
    ...
    {
        $pembina = Auth::user()->nama_lengkap;
        $eskul = Eskul::where('pembina', $pembina)->get();
        
        return view('dashboards.pembina', compact('eskul'));
    }
    ...
    public function eskulDetail($id)
    {
        ...
        // Pastikan pembina hanya bisa akses eskul yang dia bina
        ...
        return view('pembina.eskul-detail', compact('eskul', 'pendaftaran'));
    }
    ...
    public function presensi($id)
    {
        ...
        return view('pembina.presensi', compact('eskul', 'presensi'));
    }
    ...
    public function prestasi($id)
    {
        ...
        return view('pembina.prestasi', compact('eskul', 'prestasi'));
    }
}
