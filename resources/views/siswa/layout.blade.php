        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-xs">
                <div class="flex items-center space-x-3">
                    <img src="{{ asset('images/logo13.png') }}" alt="Logo Kultilas" class="h-7 w-7 object-contain">
                    <p>&copy; 2025 <span class="font-semibold text-gray-800 dark:text-white">Kultilas</span>. SMKN 13 Bandung. All rights reserved.</p>
                </div>
