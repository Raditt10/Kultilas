        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6">
                        <h4 class="text-md font-semibold mb-3">Ekstrakurikuler yang Anda Latih:</h4>
                        
                        @if($eskul->isEmpty())
                            <p class="text-gray-500">Anda belum ditugaskan untuk melatih eskul manapun.</p>
                        @else
